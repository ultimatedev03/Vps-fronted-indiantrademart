    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-[#059669] text-white py-20 px-4 text-center">
           ...
           <p className="text-xl text-green-100 w-[44vw] mx-auto mb-8">
        ...
        <div className="bg-white py-16">
           <div className="w-[92vw] mx-auto text-center">
             ...
             <div className="w-[28vw] mx-auto bg-white border-2 border-[#059669] rounded-2xl p-8 shadow-xl relative overflow-hidden">
