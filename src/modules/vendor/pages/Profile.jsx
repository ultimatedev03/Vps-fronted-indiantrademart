...
const Profile = () => {
  ...
  const enrichedProfileForPlan = {
    ...profile,
    active_plan: profile.active_plan || subscription?.plan || null,
    plan_entitlements: profile.plan_entitlements || profile.active_plan?.entitlements || subscription?.plan?.entitlements || null,
